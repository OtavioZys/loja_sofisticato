        ...
        <div className="container-fluid">
          ...
          <div className={`navbar-collapse ${menuOpen ? 'in' : ''}`} id="myNavbar">
            <ul className="nav navbar-nav">
              ...
              <li><a href="https://br.pinterest.com/sofisticatomoveis/"><i className="bi bi-pinterest"></i></a></li>
              <li><a href="https://www.instagram.com/sofisticatomoveis/"><i className="bi bi-instagram"></i></a></li>
            </ul>
          </div>
        </div>
      </nav>
